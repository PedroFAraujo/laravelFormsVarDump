...
@section('conteudo')
    ...
    <div>
        <h1 class="text-5xl font-bold">Nossos Cursos</h1>
    </div>

    <div class="flex flex-col justify-between items-center md:flex-row">
            <div class="p-3">
                <h2 class="bg-red-700 w-80 p-5 rounded-full text-lg text-slate-50 font-bold text-center">Desenvolvimento de Sistemas</h2>
            </div>
            <div class="p-3">
                <h2 class="bg-red-700 w-80 p-5 rounded-full text-lg text-slate-50 font-bold text-center">Contabilidade</h2>
            </div>
            <div class="p-3">
                <h2 class="bg-red-700 w-80 p-5 rounded-full text-lg text-slate-50 font-bold text-center">Logística</h2>
            </div>
    </div>

    <div class="flex flex-col justify-between items-center md:flex-row">
            <div class="p-3">
                <h2 class="bg-red-700 w-80 p-5 rounded-full text-lg text-slate-50 font-bold text-center">Recursos Humanos</h2>
            </div>
            <div class="p-3">
                <h2 class="bg-red-700 w-80 p-5 rounded-full text-lg text-slate-50 font-bold text-center">Serviços Jurídicos</h2>
            </div>
            <div class="p-3">
                <h2 class="bg-red-700 w-80 p-5 rounded-full text-lg text-slate-50 font-bold text-center">Administração</h2>
            </div>
    </div>
