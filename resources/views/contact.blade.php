...
<body class="bg-slate-50">
    ...
    <div class="flex flex-col justify-center items-center py-5">
        ...
        <div>
            <h1 class="my-5 text-4xl text-red-700 font-bold">Entre em Contato</h1>
        </div>
        ...
        <form action="{{route('contact')}}" method="post">
            ...
            <div class="col-span-full">
                <label for="Nome" class="block text-sm font-medium leading-6 text-red-700">Nome</label>
                <div class="mt-2">
            ...
            <div class="my-5 col-span-full">
                <label for="tel" class="block text-sm font-medium leading-6 text-red-700">Telefone</label>
                <div class="mt-2">
            ...
            <!--TELEFONE-->
            <div class="my-5 col-span-full">
                <label for="adress" class="block text-sm font-medium leading-6 text-red-700">Endereço</label>
                <div class="mt-2">
            ...
            <div class="my-5 sm:col-span-3">
                <label for="sexo" class="block text-sm font-medium leading-6 text-red-700">Sexo</label>
                <div class="mt-2">
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                <button type="submit" class="rounded-md bg-red-700 px-3 py-2 w-96 text-sm font-semibold text-white shadow-sm hover:bg-red-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Enviar</button>
            </div>
